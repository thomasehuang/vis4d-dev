...
def get_train_transforms(image_size: tuple[int, int], normalize_image: bool):
    """Get the default train transforms for BDD100K tracking."""
    ...
    return preprocess_transforms, train_batchprocess_cfg


def get_test_transforms(image_size: tuple[int, int], normalize_image: bool):
    """Get the default test transforms for BDD100K tracking."""
    preprocess_transforms = [
